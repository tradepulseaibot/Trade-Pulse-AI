(function() {
  ...
  let currentInvestMinInCurrency = 0; // store the current investment minimum in the active currency
  ...
  function openDepositModal() {
    // Force sync from the top pill before opening (fix for issues #1 and #8)
  ...
  function openInvestModal(planName, minNgn, planKey) {
    ...
    currentInvestMinInCurrency = minInCurrency; // store for validation
