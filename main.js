// ===== Trade Pulse AI – main.js (FINAL – all features integrated) =====
(function() {
      ...
      toggle.addEventListener('change', function() {
        ...
        if (enabled) {
          ...
          if (user) {
            ...
            existingData.demoStartTime = Date.now(); // set start time
  ...
  function showOnboardingStep(index) {
    ...
    $('onboardingText').innerHTML = `<h3 style="margin-top:0">${step.title}</h3><p>${step.text}</p>`;
    ...
    if (step.position === 'bottom') {
      ...
      arrow.style.borderBottom = '20px solid #0d1128';
      ...
      arrow.style.borderTop = '20px solid #0d1128';
  ...
  function tryInitialize() {
    ...
    // Start onboarding tour after terms modal would have been dismissed (or after 5s)
