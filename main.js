// ===== Trade Pulse AI – main.js (FINAL with per‑user admin management panel) =====
(function() {
  ...
  function getForcedDemoKey(username) {
    return `forcedDemo_${username}`;
  }

  function getForcedDemoData(username) {
    try {
      return JSON.parse(localStorage.getItem(getForcedDemoKey(username)) || 'null');
    } catch { return null; }
  }
  ...
  // ---- SHARED KYC STATE (for demo simulation) ----
