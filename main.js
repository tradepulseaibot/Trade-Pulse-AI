// ===== Trade Pulse AI – main.js (final – all fixes forced) =====
(function() {
  console.log('main.js loaded – final forced version');
  ...
  function setView(v) {
    ...
    updateAll();
    if (v === 'wallet') {
      setTimeout(() => renderWalletAccounts(), 100);
      setTimeout(() => renderWalletAccounts(), 500);
    }
    toggleBanner(v === 'home');
  ...
  window.addEventListener('load', () => {
    if ($('walletView').classList.contains('active')) {
      setTimeout(() => renderWalletAccounts(), 200);
    }
  });
})();
