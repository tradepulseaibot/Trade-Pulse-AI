// ===== Trade Pulse AI – main.js (FINAL – all fixes, per‑user flags, onboarding highlight) =====
(function() {
  ...
  let __onboardingScrollTimer = null;  // for smooth scroll timing
    ...
    if (step.position === 'center') {
      ...
      onboardingSteps.forEach(s => {
        if (s.target) {
          ...
          if (el) { el.style.boxShadow = ''; el.style.zIndex = ''; el.style.position = ''; }
        }
      });
      return;
    }
  ...
  function nextOnboardingStep() {
    ...
    if (prevTarget) { prevTarget.style.boxShadow = ''; prevTarget.style.zIndex = ''; prevTarget.style.position = ''; }
  ...
  function initializeApp() {
    ...
    if (sessionStorage.getItem('justSignedUp')) {
      // New user – always show everything for this account
