// ===== Trade Pulse AI – main.js (FULL with admin toggle + forced demo 20k, smooth updates, referral fix) =====
(function() {
  ...
  function updateAll() {
    // Force demo mode override (balance only initialised once, no saveUser) – 20,000 NGN
    if (isForcedDemoActive()) {
      const user = getStoredUser();
      if (user) {
      ...
      if (base.homeBalance === 0) {
        base.homeBalance = 20000;
        base.walletTotal = 20000;
        base.walletAvailable = 20000;
      }
      base.totalInvested = 20000;
      base.totalWithdrawn = 0;
      base.activePlans = 0;
      base.walletLocked = 0;
      base.withdrawable = 0;
      base.totalProfit = base.homeBalance - 20000;
  ...
  setInterval(() => {
    ...
    if (isForcedDemoActive()) {
      ...
      base.withdrawable = 0;
      base.totalProfit = newBalance - 20000; // profit above initial 20k
