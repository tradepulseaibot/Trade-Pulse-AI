...
(function() {
  console.log('main.js FINAL – all issues resolved');
  ...
  // ★ The old renderWithdrawForm('bank') call has been removed; the form is built only after initialization.
  ...
  let initAttempts = 0;
  (function pollInit() {
    if (tryInitialize() || ++initAttempts > 50) return;
