(function() {
  ...
  // ========== UPDATE ALL ==========
  function updateAll() {
    // Always update the currency pill and selected state first
  ...
  function openDepositModal() {
    // Force sync from the top pill before opening
  ...
  // Shared Payment Modal (opens with correct currency label)
