// ===== Trade Pulse AI – main.js (v2.2 – Polling Init + Instant Withdraw Form) =====
(function() {
  console.log('main.js v2.2 – Polling init & instant withdraw form');
  ...
  // ========== ULTRA-RELIABLE INITIALIZATION (polling) ==========
