...
(function() {
  ...
  // ========== FIX #3: DYNAMIC WALLET ACCOUNTS (bulletproof) ==========
  ...
  function updateMethodCardsVisibility() {
    ...
    if (bankCard) {
      if (currentCurrency === 'USDT') {
        ...
        bankCard.classList.add('method-hidden');
      } else {
        bankCard.style.setProperty('display', '', 'important');
        bankCard.classList.remove('method-hidden');
      }
    }
