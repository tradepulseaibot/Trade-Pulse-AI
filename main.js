// ===== Trade Pulse AI – main.js (FINAL – button hides on Community, modal support, all prior fixes) =====
(function() {
  ...
  // For dropdown – still defined but not used in dropdown (dropdown stays text only)
  ...
  function updateCurrencyDropdownIcons() {
    // Intentionally empty – dropdown items stay text only
  }
  ...
  function setView(v) {
    ...
    // ---- HIDE/SHOW GLOBAL INSTALL BUTTON ----
    if (v === 'community') {
