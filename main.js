(function() {
  ...
  const depositPresets = {
    NGN: [7500, 10000, 25000, 50000, 100000],  // now starts at 7500
  ...
  $('currencyDropdown').addEventListener('click', e => {
    ...
    // Force re-render withdrawal form when on withdrawal view
  ...
  function setView(v) {
    ...
    updateAll();
    if (v === 'wallet') renderWalletAccounts();   // ensure wallet accounts show
    toggleBanner(v === 'home');
