// ===== Trade Pulse AI – main.js (FINAL – all fixes + CAD/JPY/AUD currencies, no icon on button, dropdown icons, USDT symbol as "USDT") =====
(function() {
  ...
  // SVG icon generator for currency dropdown only
  function getCurrencyIconSVG(currency) {
    ...
    const colors = {
      ...
      EUR: '#a855f7',    // purple
      GBP: '#f59e0b',    // amber
      NGN: '#a855f7',    // purple (same as EUR)
      CAD: '#ec4899',    // pink
      JPY: '#f59e0b',    // amber (same as GBP)
      AUD: '#3b82f6'     // blue
    };
  ...
  function updateCurrencyDropdownIcons() {
    document.querySelectorAll('.currency-option').forEach(option => {
      ...
      const iconSpan = option.querySelector('.currency-option-icon');
      if (iconSpan) {
        iconSpan.innerHTML = getCurrencyIconSVG(currency);
      }
    });
  }
    ...
    if (currentCurrency === 'USDT') {
      ...
      container.innerHTML = `
        <div class="wallet-account">
          <div class="wallet-account-top-row">
            <div class="wallet-account-left">
              <div class="wallet-coin green" style="background:linear-gradient(135deg, #15803d, #22c55e)">USDT</div>
        ...
        <div class="wallet-account">
          <div class="wallet-account-top-row">
            <div class="wallet-account-left">
              <div class="wallet-coin amber" style="background:linear-gradient(135deg, #a16207, #f59e0b)">USDT</div>
              <div class="wallet-account-info">
  ...
  function updateAll() {
    ...
    // Currency button – plain text, no SVG
