// ===== Trade Pulse AI – main.js (FINAL – eye‑toggle & first‑visit fix) =====
(function() {
  console.log('main.js FINAL – eye‑toggle & first‑visit fix');
  ...
  // View Switching
  function setView(v) {
    // ★ Ensure app is fully initialized before showing any view
    tryInitialize();
