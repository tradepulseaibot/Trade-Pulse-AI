// ===== Trade Pulse AI – community.js (DEBUG VERSION) =====
(function() {
  ...
  // ---- ORIGINAL CODE (with debug injections) ----
  ...
  // ... rest of original code (personaNames, messageCategories, etc.) exactly same as previous version ...

  // (to keep this answer concise, I'll note that you should replace the ENTIRE content from here to the end with the original code,
  //  but inject debug calls at the specific points shown below.)

  // ---- INJECT DEBUGGING INTO KEY FUNCTIONS ----

  // getUserAnnouncementDates (DEBUGGED)
  ...
  // switchToMarketUpdates (DEBUGGED)
  ...
  // ... rest of original functions (switchToGeneralChat, etc.) remain unchanged,
  // except we also add debugLog in startCommunitySimulation:
