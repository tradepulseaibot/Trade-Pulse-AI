// ===== Trade Pulse AI – community.js (FULL – humanized, scrollable, typing indicator) =====
(function() {
  console.log('community.js loaded (humanized v3)');
  ...
  function startCommunitySimulation() {
    try {
      ...
      // Make the chat column scrollable so all messages can be seen
      ensureChatScrollable();

      // Create typing indicator element (styled to stand out)
