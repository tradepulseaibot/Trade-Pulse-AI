(function() {
  ...
  // (Insert all the live withdrawal code from previous version exactly as provided – omitted for brevity here but will be identical to the full version)
  // ... [live withdrawals code unchanged] ...
    ...
    container.innerHTML = `
      <div class="section" style="margin-top:0;">
        ...
        ${announcementsTemplate.map(a => {
          // For announcement 1, inject the closing date into description
  ...
  // ... switchToGeneralChat, switchToWinsProofs, switchToMarketUpdates, switchToHelpDesk ...
