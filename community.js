// ===== Trade Pulse AI – community.js (FULL – all features, unread badge fix, human tweaks, NO debug panel) =====
(function() {
  ...
  function createChatCard(persona, message, timestamp, replyTo = null) {
    ...
    // Card wrapper with overflow visible & flex-shrink:0 to prevent clipping
  ...
  function startCommunitySimulation() {
    try {
      ...
      // Force typing test after 5 seconds (optional)
      setTimeout(() => {
