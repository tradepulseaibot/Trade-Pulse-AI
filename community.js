// ===== Trade Pulse AI – community.js (FIXED: polished install modal for pill) =====
(function() {
  ...
  // ========== PERSISTENT DOWNLOAD APP PILL (polished modal) ==========
  (function createDownloadPill() {
    ...
    // Sync with the global deferredPrompt (if any) and also capture our own
    ...
    pill.addEventListener('click', async () => {
      if (window.deferredPWA) {
        ...
        // Show the polished modal instead of alert
