(function() {
  ...
  // ----- WHITE BACKGROUND EXCEPTIONS (aligned with main.js) -----
  const whiteBgExceptions = [
  ...
  const fallbackBankIcon = '<div style="display:inline-block;width:16px;height:16px;vertical-align:middle;border-radius:2px;background:rgba(255,255,255,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="#9ca3af" stroke-width="2"><path d="M3 21h18M3 10h18M5 6l7-3 7 3M4 10v11M20 10v11M8 14v3M12 14v3M16 14v3"/></svg></div>';
      ...
      return `<div class="live-withdrawal-row">
        ...
        <div class="live-wd-info">
          ...
          <div class="live-wd-loc">
            <img src="${w.methodIcon}" alt="" style="width:16px;height:16px;vertical-align:middle;border-radius:2px; ${bgStyle}" 
                 onerror="this.outerHTML='${fallbackBankIcon}'"> ${w.methodName}
          </div>
        </div>
        <div>
      ...
      return `<div style="display:flex; align-items:center; gap:10px; padding:12px 0; border-bottom:1px solid rgba(255,255,255,.04);">
        ...
        <div style="flex:1; min-width:0;">
          ...
          <div style="font-size:11px; color:#9ca3af;">
            <img src="${w.methodIcon}" alt="" style="width:16px;height:16px;vertical-align:middle;border-radius:2px;margin-right:4px; ${bgStyle}" 
                 onerror="this.outerHTML='${fallbackBankIcon}'"> ${w.methodName}
          </div>
        </div>
