// ===== Trade Pulse AI – community.js (FINAL with bulletproof announcement dates) =====
(function() {
  ...
  function getUserAnnouncementDates() {
    ...
    if (user.announcementDates && Array.isArray(user.announcementDates) && user.announcementDates.length === 12) {
      const valid = user.announcementDates.every(d => d.id && typeof d.postedStr === 'string');
  ...
  function renderAnnouncements() {
    ...
    const getDateForId = (id) => {
      ...
      if (found && typeof found.postedStr === 'string') return found.postedStr;
      return 'Unknown date';
    };
