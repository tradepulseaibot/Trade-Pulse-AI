// ===== Trade Pulse AI – community.js (FULL – humanized, scrollable, typing indicator, debug panel, more joins) =====
(function() {
  console.log('community.js loaded (humanized v5)');
  ...
  // ========== CHAT PACE: add messages gradually (typing indicator probability 50%) ==========
  ...
  function addRandomChatMessage() {
    ...
    // 50% chance to show typing indicator
  ...
  // ========== JOIN NOTIFICATIONS (increased frequency) ==========
