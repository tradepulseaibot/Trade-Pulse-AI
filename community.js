// ===== Trade Pulse AI – community.js (FINAL – no proof cards, all personas merged) =====
(function() {
  console.log('community.js loaded (final clean)');
  ...
  // ========== (Proof card code completely removed – no withdrawalProofPersonas, no createProofChatCard, etc.) ==========
  ...
  function startCommunitySimulation() {
    try {
      ...
      // NO proof card interval – completely removed
